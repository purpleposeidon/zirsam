...
TODO = """
The code is released under GPLv3. Much of the contents of the sub-directories were created by others, in some cases, modified by myself. I reserve the right to change this at any time or permit others to use it under other licenses, unless that's illegal, in which case this sentence does not apply.
